...
! purpose : find the little group for a specific k point
! status  : robust
...
real(dp),  public ,  parameter  :: TOLDG  = 0.8E-3
...
!.......calculate the characters: Ref [6] p46
       !only use FL(2)
        call CHRCT(NMAT,NUME,A,B,SU2,EE,L,PH,XM,FL,NE,NV,LKG,IKG,IORD,KKK)
      ENDIF
!
