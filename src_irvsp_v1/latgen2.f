      SUBROUTINE LATGEN2(LATTIC,ANG,BR1,BR2,ORTHO)
...
!
      LOGICAL          ORTHO           
      CHARACTER*4      LATTIC
      DIMENSION        BR1(3,3),BR2(3,3),ANG(3),ALPHA(3),PIA(3)   
!                             
!---------------------------------------------------------------------  
!                      
      PI=ACOS(-1.0D0)                                                   
      SQRT3=SQRT(3.D0)
      ALPHA(1)=ANG(1)*PI/180.0D0                                             
      ALPHA(2)=ANG(2)*PI/180.0D0                                             
      ALPHA(3)=ANG(3)*PI/180.0D0                                             
!las----------------------------------------- !!!!!!!!!!!!!!!!!!!
      PIA(1)=1.D0
      PIA(2)=1.D0
      PIA(3)=1.D0
