...
!
 ...
 20   CONTINUE
      IF(SUMP.GT.9*TOL) THEN
         WRITE(6,'(3F12.6)') (A(I1),I1=1,3)
         WRITE(6,'(3F12.6)') (RM(1,I1),I1=1,3)
         WRITE(6,'(3F12.6)') (RM(2,I1),I1=1,3)
         WRITE(6,'(3F12.6)') (RM(3,I1),I1=1,3)
         WRITE(6,'(3F12.6)') (RM2(1,I1),I1=1,3)
         WRITE(6,'(3F12.6)') (RM2(2,I1),I1=1,3)
         WRITE(6,'(3F12.6)') (RM2(3,I1),I1=1,3)
