      SUBROUTINE RMPROP(IZ,IIZ,TAU,IORD,DZ2,SU2,SU2t,JIJ,ILC,RAN,RNAM)
...
!
      ...
      COMPLEX*16       SU2(2,2,NSYM),SU2t(2,2,NSYM),SDET
...
!.....output
  ...
  410     WRITE(6,515)(IZ(I1,I2,I),I2=1,3),TAU(I1,I), &
            (IIZ(I1,I2,I),I2=1,3), &
            (DZ2(I1,I2,I),I2=1,3),ANG(I1,I),(SU2t(I1-1,I2,I),I2=1,2)
       WRITE(6,517) I
       IF(ILC(I).GE.1) THEN
